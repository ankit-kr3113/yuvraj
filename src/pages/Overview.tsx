              ...
              <div className="space-y-6 md:space-y-8 fade-in order-2 lg:order-1 text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
                ...
                <div className="space-y-4 md:space-y-6">
                  <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight tracking-tight">
                    <span className="flex text-muted-foreground text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mb-3 md:mb-4 animate-fade-in-up items-center gap-2">
              ...
              <div className="hidden lg:block relative slide-up order-1 lg:order-2">
                <div className="relative flex justify-center w-full max-w-lg xl:max-w-xl mx-auto">
                  ...
                  <div className="relative z-10 w-64 h-64 sm:w-72 sm:h-72 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden border-4 border-primary/40 shadow-2xl hover:shadow-primary/50 hover:shadow-2xl transition-all duration-500 hover:scale-110 group mx-auto cursor-pointer backdrop-blur-sm">
                    ...
                    {/* Status Badge */}
                    <div className="absolute bottom-4 right-4 bg-gradient-to-r from-green-500/95 to-emerald-500/95 backdrop-blur-sm text-white text-sm px-3 py-2 rounded-full font-semibold shadow-lg opacity-90 group-hover:opacity-100 transition-all duration-300 transform group-hover:scale-110 border-2 border-white/30">
                      <span className="animate-pulse">●</span> Available
                    </div>
                  </div>

                  {/* Achievement Float Cards - Hidden on small screens */}
                  <div className="hidden md:block absolute top-4 -right-2 lg:-right-4 w-28 h-24 md:w-32 md:h-28 bg-card/98 backdrop-blur-lg rounded-2xl border-2 border-primary/40 p-4 md:p-5 shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-125 animate-float
                   [animation-duration:1.5s] z-20">
                    ...
                    <div className="text-base md:text-lg text-primary font-bold text-center leading-tight">
                      {achievements.stats.totalProjects}
                    </div>
                  ...
                  <div className="hidden md:block absolute bottom-4 -left-2 lg:-left-4 w-28 h-24 md:w-32 md:h-28 bg-card/98 backdrop-blur-lg rounded-2xl border-2 border-primary/40 p-4 md:p-5 shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-125 animate-float  animation-delay-1000 z-20">
                    <div className="flex justify-center mb-2">
                  ...
                  <div className="hidden md:block absolute top-1/2 -translate-y-1/2 -right-2 lg:-right-4 w-28 h-24 md:w-32 md:h-28 bg-card/98 backdrop-blur-lg rounded-2xl border-2 border-primary/40 p-4 md:p-5 shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-125 animate-float animation-delay-2000 z-20">
                    <div className="flex justify-center mb-2">
