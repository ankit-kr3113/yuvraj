            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-20 xl:gap-24 items-center">
              ...
              <div className="hidden lg:block relative slide-up order-1 lg:order-2">
                <div className="relative flex justify-center w-full max-w-lg xl:max-w-xl mx-auto">
                  ...
                  <div className="hidden md:block absolute top-4 -right-2 lg:-right-4 w-24 h-20 md:w-28 md:h-24 bg-card/98 backdrop-blur-lg rounded-2xl border-2 border-primary/40 p-3 md:p-4 shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-125 animate-float [animation-duration:6s] z-20">
